package cn.yuzhizhe.launch_simple.launchstarter;
...
import cn.yuzhizhe.launch_simple.launchstarter.sort.TaskSortUtil;
import cn.yuzhizhe.launch_simple.launchstarter.stat.TaskStat;
import cn.yuzhizhe.launch_simple.launchstarter.task.DispatchRunnable;
import cn.yuzhizhe.launch_simple.launchstarter.task.Task;
import cn.yuzhizhe.launch_simple.launchstarter.task.TaskCallBack;
import cn.yuzhizhe.launch_simple.launchstarter.utils.DispatcherLog;
import cn.yuzhizhe.launch_simple.launchstarter.utils.Utils;

/**
 * @ProjectName: Launch_Simple
 * @Package: cn.yuzhizhe.launch_simple.launchstarter
 * @ClassName: TaskDispatcher
 * @Description: 类作用描述:启动器调用类
 * @Author: yuzhizhe
 * @CreateDate: 2021/4/3 11:06
 * @Version: 1.0
 * *******************************
 * @UpdateUser: 无
 * @UpdateDate: 无
